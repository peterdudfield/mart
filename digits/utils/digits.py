...
class Digits:
    ...
    def make_image(self):
        ...
        for i in range(N):  
            ...
            if letter_array_color[y,x]==1:
                ...
                temp_array[idx,0] = temp_array[idx,0] +  (1-temp_array[idx,0]/255)*colors[str(int(letter_array[y,x]))][0]
                temp_array[idx,1] = temp_array[idx,1] +  (1-temp_array[idx,1]/255)*colors[str(int(letter_array[y,x]))][1]
                temp_array[idx,2] = temp_array[idx,2] +  (1-temp_array[idx,2]/255)*colors[str(int(letter_array[y,x]))][2]
    ...
    def plot_digits(self,
        ...
        if name==None:
            ...
            plt.title(r"$" + letter_latex.replace('$', '') + '$' +' '*len(name), fontsize=80, color='black')
            ...
            print(letter_latex)
            plt.text(self.cols/2*28 - len(name)*20/2 + drift, -5, name[1:],fontsize=60, color = 'grey')
